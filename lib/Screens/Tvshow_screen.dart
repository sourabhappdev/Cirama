...
import 'package:cinemava/Screens/Detailshow.dart';
...
class _TvshowState extends State<Tvshow> {
  ...
  late Future<List<Showmodel>> nowPlayingShow;

  @override
  void initState() {
    super.initState();
    nowPlayingShow = Api().getOnTheAirshows();

  }



  String imageurl='https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/A_black_image.jpg/640px-A_black_image.jpg';
                      ...
                      return InkWell(
                        onTap: (){
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => Detailshow(
                                  showmodel: snapshot.data![index]),
                            ),
                          );
                        },
                        child: Container(
